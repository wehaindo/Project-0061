...
class ProductProduct(http.Controller):    
    ...
    def load_pos_data(self, **kwargs):        
        try:
            ...
            if 'pos_session_id' in data:
                ...
                config_id = pos_session_id.config_id                
    ...
    @validate_token
    @http.route('/pos/decentralize/product_product/by_all', type="http", auth="none", methods=["GET"], csrf=False)
    def load_product_data_by_all(self, **kwargs):   
        try:            
            fields = [
