odoo.define('shopon_pos_theme.VariantProductItem', function (require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class ShopOnVariantProductItem extends PosComponent {
    ...
    ShopOnVariantProductItem.template = 'ShopOnVariantProductItem';

    Registries.Component.add(ShopOnVariantProductItem);

    return ShopOnVariantProductItem;
});
