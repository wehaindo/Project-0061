odoo.define('shopon_pos_theme.receipt',function(require){
    "use strict"
    ...
    const ShopOnResOrderReceipt = OrderReceipt =>
            ...
            setup(){
                ...
                onMounted(()=>{
                    ...
                    if(self.env.pos.config.is_custom_receipt){
                        var receipt_design=self.env.pos.config.setu_design_receipt
    ...
    Registries.Component.extend(OrderReceipt, ShopOnResOrderReceipt)
});
