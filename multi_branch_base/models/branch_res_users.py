...
class ResUsers(models.Model):
    ...
    bu_ids = fields.Many2many('business.unit', string='Allowed Business Unit',
                                  domain="[('company_id', '=', company_ids)]")
    bu_id = fields.Many2one("business.unit", string='Default Business Unit',
                                  domain="[('id', '=', bu_ids)]")

    branch_ids = fields.Many2many('res.branch', string='Allowed Operating Unit',
                                  domain="[('business_unit_id', '=', bu_ids)]")
    branch_id = fields.Many2one("res.branch", string='Default Operating Unit',
