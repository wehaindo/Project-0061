...
class AccountMove(models.Model):
    ...
    branch_id = fields.Many2one('res.branch', string='Operating Unit', store=True,readonly=False,default=_get_default_branch, domain=_get_branch_domain)
...
class AccountMoveLine(models.Model):
    ...
    bu_id = fields.Many2one('business.unit', string='Business Unit', store=True,)
    branch_id = fields.Many2one('res.branch', related='move_id.branch_id', string='Operating Unit', store=True)
