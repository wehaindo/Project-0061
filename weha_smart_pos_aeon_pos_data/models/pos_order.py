...
class PosOrder(models.Model):
    ...
    def create_from_ui(self, orders, draft=False):        
        ...
        for order in orders:
            ...
            order_access_token = order['data']['access_token']
            _logger.info('order_access_token : ', order_access_token)            
            ...
            if not existing_draft_order:
                ...
                existing_draft_order = self.env['pos.order'].search(['&', ('access_token', '=', order_access_token), ('state', '=', 'draft')], limit=1)
            try:
                if existing_draft_order:
                    ...
                    existing_orders = self.env['pos.order'].search([('access_token', '=', order_access_token)])                    
