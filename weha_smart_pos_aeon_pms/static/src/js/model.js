    ...
    const AeonMemberOrder = (Order) => 
        class extends Order {
            constructor(obj, options) {
                ...
                this.aeon_customer_name = this.aeon_customer_name || false;
                this.aeon_customer_email = this.aeon_customer_email || false;
            ...
            init_from_JSON(json) {
                ...
                this.aeon_customer_name = json.aeon_customer_name;
                this.aeon_customer_email = json.aeon_customer_email;
            ...
            export_as_JSON() {
                ...
                json.aeon_customer_name = this.aeon_customer_name || false;
                json.aeon_customer_email = this.aeon_customer_email || false;
            ...
            set_aeon_customer_name(aeon_customer_name){
                this.aeon_customer_name = aeon_customer_name;
            }

            get_aeon_customer_name(){
                return this.aeon_customer_name;
            }

            set_aeon_customer_email(aeon_customer_email){
                this.aeon_customer_email = aeon_customer_email;
            }

            get_aeon_customer_email(){
                return this.aeon_customer_email;
            }
            ...
            clone(){
                ...
                order.aeon_customer_name = this.aeon_customer_name;
                order.aeon_customer_email = this.aeon_customer_email;
