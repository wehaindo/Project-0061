...
class PosOrder(models.Model):
            ...
            if(self.aeon_member and not self.point_claim):
                ...
                for line in self.lines:
                    consumption = {
                        ...
                        "promo_item1":line.product_id.default_code,
                        "promo_item2":line.product_id.default_code,
                        "promo_item3":line.product_id.dept_id.code,
                        "remarks":"",
                ...
                #     pay_tool_exist = False
                #     pay_tool_dict = {}
                #     for pay_tool in pay_tools:                        
                #         if pay_tool['pay_type'] == payment_id.payment_method_id.code:
                #             pay_tool_exist = True
                #             pay_tool_dict = {
                #                 "pay_amount":pay_tool['pay_amount'] + payment_id.amount,                    
                #                 "pay_type":pay_tool['pay_type'],
                #             }
                #             break

                #     if pay_tool_exist:
                #         pay_tool_exist = False
                #         pay_tools.append(pay_tool_dict)                    
                #     else:
                #         pay = {
                #             "pay_amount":payment_id.amount,                    
                #             "pay_type":payment_id.payment_method_id.code,
                #         }
                #         pay_tools.append(pay)
                ...
                trade_data = {
                    ...
                    "consumption_amount": self.amount_total if trade_type == "sale" else -1 * self.amount_total,
                    "trade_type":trade_type,
                    "trade_lineType":1,
                    "remarks":"",
                    "trade_amount":self.amount_total if trade_type == "sale" else -1 * self.amount_total,
    ...
    def _order_fields(self, ui_order):
        ...
        order_fields['aeon_customer_name'] = ui_order.get('aeon_customer_name', False)
        order_fields['aeon_customer_email'] = ui_order.get('aeon_customer_email', False)
        return order_fields
    ...
    def _export_for_ui(self, order):
        ...
        result['aeon_customer_name'] = order.aeon_customer_name
        result['aeon_customer_email'] = order.aeon_customer_email
        return result
    ...
    aeon_customer_name = fields.Char('Customer', size=200)
    aeon_customer_email = fields.Char('Email', size=200)
