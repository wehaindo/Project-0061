...
class Agreement(models.Model):
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("supplier_sub_type") == "concessionaire":
                vals["code"] = self.env["ir.sequence"].next_by_code("agreement.concessionaire") or _('New')
            else:
                vals["code"] = self.env["ir.sequence"].next_by_code("agreement.outright") or _('New')
...
class Agreement(models.Model):
    _name = "agreement.contract.holder"
    _description = "Contract Holder"
