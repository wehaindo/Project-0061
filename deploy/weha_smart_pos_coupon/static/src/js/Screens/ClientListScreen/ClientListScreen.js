odoo.define('aspl_pos_wallet.ClientListScreen', function(require) {
    ...
    const WalletClientListScreen = ClientListScreen =>
    ...
    Registries.Component.extend(ClientListScreen, WalletClientListScreen);
