...
class AgreementRebateSettlementLine(models.Model):
    ...
    invoice_line_ids = fields.One2many(
        ...
        inverse_name='agreement_settlement_line_id',
    )
    # related="settlement_id.invoice_id.line_ids"
    ...
    def _prepare_invoice_line(self, invoice_vals):
        ...
        # invoice_line.sudo()._onchange_product_id()
        # invoice_line.sudo()._onchange_product_id_landed_costs()
