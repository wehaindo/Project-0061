odoo.define('weha_smart_pos_promotion.models', function (require) {
    "use strict";
            ...
            async apply_pos_order_discount_total(){
                ...
                for(const promotion of filteredPromotion){
                    ...
                    if(total >= promotion.total_amount){
                        ...
                        var createNewDiscountLine = new Orderline({}, {pos: this.pos,order: this.pos.get_order(), product: discountProduct});
                ...
                for(var promotion of this.pos.pos_promotions){
                    ...
                    switch (promotion_type) {
                        ...
                        case 'discount_on_multi_product':
                            console.log("discount_on_multi_product");
