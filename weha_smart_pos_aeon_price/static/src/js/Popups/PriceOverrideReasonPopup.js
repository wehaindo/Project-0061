odoo.define('weha_smart_pos_aeon_price.PriceOverrideReasonPopup', function (require) {
    'use strict';
    ...
    class PriceOverrideReasonPopup extends AbstractAwaitablePopup {
        /**
    ...
    PriceOverrideReasonPopup.template = 'PriceOverrideReasonPopup';
    PriceOverrideReasonPopup.defaultProps = {
    ...
    Registries.Component.add(PriceOverrideReasonPopup);

    return PriceOverrideReasonPopup;
});