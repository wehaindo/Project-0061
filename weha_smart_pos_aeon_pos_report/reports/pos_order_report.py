...
class PosOrderReport(models.Model):
    ...
    branch_id = fields.Many2one('res.branch', string='Store', readonly=True)
    ...
    def _from(self):
        return """
            FROM pos_order_line AS l
                ...
                LEFT JOIN res_branch rb ON (s.branch_id=rb.id)
        """

    def _group_by(self):
        return """
            GROUP BY
                s.id, s.date_order, s.branch_id, s.partner_id,s.state, pt.categ_id,
