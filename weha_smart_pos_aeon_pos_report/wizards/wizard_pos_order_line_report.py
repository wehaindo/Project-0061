...
class WizardPosOrderLineReport(models.TransientModel):
    _name = 'wizard.pos.order.line.report'
    _description = 'Point of Sale Order Line Report'   
    ...
    def generate_report(self):                            
        return self.env.ref('weha_smart_pos_aeon_pos_report.pos_order_line_report').report_action(self)