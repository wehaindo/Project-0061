odoo.define('weha_smart_pos_aeon_bca_ecr.PaymentBankManual', function(require){
    ...
    const paymentStatus = {
        ...
        WAITING_QRIS_INPUT: 'waiting_qris_input',

    }

    const _t = core._t

    const PaymentBankManual = PaymentInterface.extend({
        ...
        check_bank_manual: function(){
          return this._bank_manual_check();
        },

        _bank_manual_check: function(){
          console.log('_bank_manual_check');
          const self = this;
