...
class PosPaymentMethod(models.Model):
    ...
    def _get_payment_terminal_selection(self):
        return super(PosPaymentMethod, self)._get_payment_terminal_selection() + [('bcaecr', 'BCA ECR'),('bcaecr_manual','BCA ECR Manual')]
    ...
    def _onchange_use_payment_terminal(self):
        ...
        if self.use_payment_terminal != 'bcaecr_manual':
            self.terminal_id = False

    is_dev = fields.Boolean('Is Development', default=False)
    is_ether = fields.Boolean('Is Ethernet', default=False)
    pan = fields.Char('PAN #')
