...
class InheritPosPromotion(models.Model):
    ...
    promotion_type = fields.Selection(selection_add=[
        ('quantity_price_all', 'Fix Discount on Quantity All'),
        ('percent_discount_quantity_item', 'Percent Discount On Quantity Item'),
...
class quantity_discount_amt(models.Model):
    _inherit = 'quantity.discount.amt'

    discount_percent_price = fields.Float('Discount Price (Percent)')