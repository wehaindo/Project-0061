...
odoo.define('bi_pos_stock.pos', function(require) {
	...
	// 		console.log("MASUK KESINIII  load_product_qty");
	...
	// 					console.log("MASUK KE load_product_qty");
	...
	// 				if (self.product_list[i].type == 'product'){
	// 					prods.push(self.product_list[i].id)
	// 				}
	// 			}
