...
payload = {
    'partnerReferenceNo': 'Order 050100007',
...
token = 'bfPn5NfTUIxp71y5dtrMwlzNn6TsMixT5GKu7kcaC88GAIcKEligui'
...
x_signature = calculate_signature("POST","/v1.0/qr/qr-mpm-generate", token, payload, x_client_key, x_timestamp)
