        ...
        if self.product_couchdb_id:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    response = requests.put(f'{branch_id.couchdb_server_url}/{branch_id.couchdb_product_barcode}/{couchdb_product["_id"]}', auth=auth, headers=headers, data=product_json, verify=False)
                    if response.status_code == 200:
                        pass
