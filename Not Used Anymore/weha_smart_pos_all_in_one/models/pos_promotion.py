...
class pos_promotion(models.Model):
    ...
    type = fields.Selection([
        ...
        ('10_buy_x_get_another_free', '10. Buy min Qty get Free Items'),
        ('11_first_order', '11. Discount % first Order'),
    ], 'Type', default='1_discount_total_order', required=1, help='1: each total amount of order, each discount\n'
    ...
    method = fields.Selection([
        ...
        default='only_one',
        string='Method',
        help='Only One: If customer buy product and quantity will have condition apply Promotion \n'
             'All: required customer buy all items for have condition apply Promotion')
