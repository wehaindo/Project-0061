...
from odoo.addons.weha_smart_pos_base_api.libs.common import invalid_response, valid_response
from odoo.http import request
from odoo.exceptions import AccessError, AccessDenied

_logger = logging.getLogger(__name__)

expires_in = "weha_smart_pos_base_api.access_token_expires_in"
