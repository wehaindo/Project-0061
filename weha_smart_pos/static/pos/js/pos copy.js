...
dbInventory.post({
    "price": "12000",
    "category": "a6ff077f-55b3-4463-9a8a-b87feba7ea23",
    "quantity": 0,
    "name": "Fanta",
    "barcode": "1231231231232",
    "stock": 0,
    "_id": "bff4bfb8-27e4-4bd8-b782-edef4873e367"
}).then((docs) => {
    console.log("Create Inventory Success");
    console.log(docs);
}).catch((err) => {
    console.log("Create Inventory Failed");
    console.log(err);
});
...
dbUser.post({
    ...
    "perm_users": 1,
    "perm_settings": 1,
    "status": "Logged In_Mon May 16 2022 08:42:03 GMT+0700 (Western Indonesia Time)"
}).then((docs) => {
    console.log(docs);
}).catch((err) => {
    console.log(err);
