...
class PosSession(models.Model):
    ...
    def _loader_params_pos_promotion(self):
        res = {
            'search_params': {
                'domain': [('branch_ids','in', self.config_id.res_branch_id.id),('active','=',True)],
                'fields': [],
            },
        }
        return res
    ...
    def _loader_params_pos_conditions(self):
        res = {
            'search_params': {
                'domain': [('pos_promotion_rel.branch_ids','in',self.config_id.res_branch_id.id),('active','=',True)],
                'fields': [],
            },
        }
        return res
    ...
    def _loader_params_partial_quantity_fixed_price(self):
        res = {
            'search_params': {
                'domain': [('pos_promotion_id.branch_ids','in',self.config_id.res_branch_id.id),('active','=',True)],
                'fields': [],
            },
        }
        return res
    ...
    def _loader_params_get_discount(self):
        res = {
            'search_params': {
                'domain': [('pos_quantity_dis_rel.branch_ids','in',self.config_id.res_branch_id.id),('active','=',True)],
                'fields': [],
            },
        }
        return res        
    ...
    def _loader_params_quantity_discount(self):        
        res = {
            'search_params': {
                'domain': [('pos_quantity_rel.branch_ids','in',self.config_id.res_branch_id.id),('active','=',True)],
                'fields': [],
            },
        }
        return res        
    ...
    def _loader_params_quantity_discount_amt(self):
        res = {
            'search_params': {
                'domain': [('pos_quantity_amt_rel.branch_ids','in',self.config_id.res_branch_id.id),('active','=',True)],    
                'fields': [],
            },
        }
        return res
    ...
    def _loader_params_fixed_price_multi_products(self):
        res = {
            'search_params': {
                'domain': [('promotion_id.branch_ids','in',self.config_id.res_branch_id.id),('active','=',True)],
                'fields': [],
            },
        }
        return res
    ...
    def _loader_params_discount_multi_products(self):        
        res = {
            'search_params': {
                'domain': [('multi_product_dis_rel.branch_ids','in',self.config_id.res_branch_id.id),('active','=',True)],
                'fields': [],
            },
        }
        return res      
    ...
    def _loader_params_discount_multi_categories(self):
        ...
        res = {
            'search_params': {
                'domain': [('multi_category_dis_rel.branch_ids','in',self.config_id.res_branch_id.id),('active','=',True)],
                'fields': [],
            },
        }
        return res        
